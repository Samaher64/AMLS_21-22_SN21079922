...
os.listdir('/content/drive/MyDrive/data/Brain/dataset/dataset/image')

import cv2
for file in tqdm(os.listdir('/content/drive/MyDrive/data/Brain/dataset/dataset/image')):
    #print(file)
    ex_img = cv2.imread('/content/drive/MyDrive/data/Brain/dataset/dataset/image/' + file)
    ex_crop_img = crop_brain_contour(ex_img, False)
    filename= '/content/drive/MyDrive/data/Brain/crop/'+ file
    #print(filename)
...
# Not Normalized
cm = confusion_matrix(text_y,pred )
print(cm)
